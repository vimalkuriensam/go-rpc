...
type LogsServiceClient interface {
	AddLogs(ctx context.Context, in *LogsRequest, opts ...grpc.CallOption) (*LogsResponse, error)
}
...
func (c *logsServiceClient) AddLogs(ctx context.Context, in *LogsRequest, opts ...grpc.CallOption) (*LogsResponse, error) {
	out := new(LogsResponse)
	err := c.cc.Invoke(ctx, "/proto.LogsService/AddLogs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LogsServiceServer interface {
	AddLogs(context.Context, *LogsRequest) (*LogsResponse, error)
...
func (UnimplementedLogsServiceServer) AddLogs(context.Context, *LogsRequest) (*LogsResponse, error) {
...
func _LogsService_AddLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LogsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LogsServiceServer).AddLogs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.LogsService/AddLogs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogsServiceServer).AddLogs(ctx, req.(*LogsRequest))
	}
...
var LogsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.LogsService",
	HandlerType: (*LogsServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AddLogs",
			Handler:    _LogsService_AddLogs_Handler,
		},
	},
